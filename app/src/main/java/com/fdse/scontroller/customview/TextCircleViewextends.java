...
public class TextCircleViewextends extends TextView {

    private Paint mPaint;

    public TextCircleViewextends(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
    }

    //xml创建TextCircleView调用这个构造函数
    public TextCircleViewextends(Context context, AttributeSet attrs) {
        super(context, attrs);
        // TODO Auto-generated constructor stub
        init();
    }
    ...
    public TextCircleViewextends(Context context, AttributeSet attrs, int defStyle) {
