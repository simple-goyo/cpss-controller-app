...
//        }, 1000, 300000);
    ...
    private WebViewClient webViewClient = new WebViewClient() {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (url.equals("http://www.google.com/")) {
                Toast.makeText(HousekeeperActivity.this, "国内不能访问google,拦截该url", Toast.LENGTH_LONG).show();
    ...
    //保存任务信息
    private void getHousekeeperTask() {

        String serviceURL = UrlConstant.getAppBackEndServiceURL(UrlConstant.APP_BACK_END_QUICKAPP_QUERY_INFO);
        HttpUtil.sendOkHttpRequestByGet(serviceURL, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (((int)responceDataJson.get("state"))==0) {
...
//                    }
                ...
                }else if(((int)responceDataJson.get("state"))==3){
    ...
    private void refresh() {
        finish();
        Intent intent = new Intent(HousekeeperActivity.this, HousekeeperActivity.class);
